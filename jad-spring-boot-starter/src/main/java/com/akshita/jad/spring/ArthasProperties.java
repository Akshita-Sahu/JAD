...
public class JADProperties {
	...
	/**
	 * when jad agent init error will throw exception by default.
	 */
     ...
     *  jadConfigMap ，，
     */
    public static void updateJADConfigMapDefaultValue(Map<String, String> jadConfigMap) {
        if (!jadConfigMap.containsKey("disabledCommands")) {
            jadConfigMap.put("disabledCommands", DEFAULT_DISABLEDCOMMANDS);
        }
    }
