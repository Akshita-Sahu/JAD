...
const transformMemory = (result: JADResResult) => {
...
const transformThread = (result: JADResResult, end: number) => {
...
const transformGc = (result: JADResResult) => {
  if (result.type !== "dashboard") return;
...
const transformRuntimeInfo = (result: JADResResult) => {
  if (result.type !== "dashboard") return;
