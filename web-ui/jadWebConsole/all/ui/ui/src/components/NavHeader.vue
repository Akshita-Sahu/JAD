...
import pic from "~/assert/jad.png"
...
const shutdown = () => {
  publicS.warnMessage = "Are you sure to stop the jad? All the JAD clients connecting to this server will be disconnected."
  publicS.warningFn = () => {
    fetchS.baseSubmit(interpret(permachine), {
      command: "stop",
      action: "exec"
...
<template>
  <nav class=" h-[10vh] border-b-2 navbar bg-base-100">
    <div class=" navbar-start flex items-stretch">
      ...
      <a class="flex items-center justify-center mx-2" href="https://github.com/Akshita-Sahu/JAD/doc/commands.html"
        target="_blank">
