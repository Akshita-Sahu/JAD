...
import jadLogo from "~/assert/jad.png"
...
const JAD_PORT = isTunnel ? "7777" : "8563"
const ip = ref("")
const port = ref('')
...
const outputHerf = computed(() => {
  ...
  return isTunnel?`proxy/${agentID.value}/jad-output/`:`/jad-output/`
})
...
onMounted(() => {
  ...
  port.value = getUrlParam('port') ?? JAD_PORT;
...
function getWsUri() {
  ...
  const uri = `${protocol}${host}/${encodeURIComponent(path)}?method=connectJAD&id=${agentID.value}`
      ...
      <div class="navbar-start">
        <div class="dropdown dropdown-start 2xl:hidden">
          ...
          <ul tabindex="0" class="dropdown-content menu shadow bg-base-100">
            <li>
              <a class="hover:text-sky-500 dark:hover:text-sky-400 text-sm" href="https://github.com/Akshita-Sahu/JAD/doc"
                target="_blank">Documentation
                <span class="sr-only">(current)</span></a>
            </li>
            <li>
              <a class="hover:text-sky-500 dark:hover:text-sky-400 text-sm"
                href="https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html" target="_blank">Online
                Tutorials</a>
            </li>
            <li>
              <a class="hover:text-sky-500 dark:hover:text-sky-400 text-sm" href="https://github.com/akshita-sahu/jad"
                target="_blank">Github</a>
            </li>
          </ul>
        </div>
        <a href="https://github.com/akshita-sahu/jad" target="_blank" title="" class="mr-2 w-20"><img
            :src="jadLogo" alt="JAD" title="Welcome to JAD web console"></a>
      ...
      <div class="navbar-end">
        ...
        :class="{
          ...
          <a class="btn btn-sm bg-secondary hover:bg-secondary-focus border-none text-secondary-content focus:bg-secondary-focus normal-case"
            :href="outputHerf" target="_blank">JAD Output</a>
        </div>
      </div>
    </nav>
