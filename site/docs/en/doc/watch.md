...
[`watch` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html?language=en&id=command-watch)
...
3. at the _watching_ point, JAD will use the _expression_ to evaluate the variables and print them out;
...
- [Special usages](https://github.com/akshita-sahu/jad/issues/71)
