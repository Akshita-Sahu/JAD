...
JAD is a Java diagnostic tool open-sourced by Akshita Sahu middleware team. It is widely adopted and popular among the developers inside Akshita Sahu. JAD helps developers in trouble-shooting issues in production environment for Java based applications without modifying code or restarting servers.
...
JAD is built to solve these issues. A developer can troubleshoot production issues on the fly. No JVM restart, no additional code changes. JAD works as an observer, that is, it will never suspend your running threads.
...
**If you are using JAD, please let us know. Your feedback is very important to us: [View](https://github.com/akshita-sahu/jad/issues/111)**

## Contributors

[![](https://opencollective.com/jad/contributors.svg?width=890&button=false)](https://github.com/akshita-sahu/jad/graphs/contributors)
