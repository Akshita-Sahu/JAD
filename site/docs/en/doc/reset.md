...
[`reset` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html?language=en&id=command-reset)

::: tip
Reset all classes that have been enhanced by JAD. These enhanced classes will also be reset when JAD server is `stop`.
:::
