...
[`sc` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials?language=en&id=command-sc)
...
::: tip
_class-patten_ supports full qualified class name, e.g. com.akshita-sahu.test.AAA and com/akshita-sahu/test/AAA. It also supports the format of 'com/akshita-sahu/test/AAA', so that it is convenient to directly copy class name from the exception stack trace without replacing '/' to '.'.
:::
