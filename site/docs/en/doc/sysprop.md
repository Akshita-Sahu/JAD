...
[`sysprop` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html?language=en&id=command-sysprop)
...
```
 ...
 WIKI:
   https://github.com/Akshita-Sahu/JAD/doc/sysprop
