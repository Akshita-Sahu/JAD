...
[`jad` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials?language=en&id=command-jad)
...
- The decompiled code is syntax highlighted for better readability in JAD console.
