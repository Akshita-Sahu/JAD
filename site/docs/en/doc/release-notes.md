...
- [https://github.com/akshita-sahu/jad/releases/tag/jad-all-3.1.1](https://github.com/akshita-sahu/jad/releases/tag/jad-all-3.1.1)

## v3.1.0

- [https://github.com/akshita-sahu/jad/releases/tag/3.1.0](https://github.com/akshita-sahu/jad/releases/tag/3.1.0)

## v3.0.5

- [https://github.com/akshita-sahu/jad/releases/tag/jad-all-3.0.5](https://github.com/akshita-sahu/jad/releases/tag/jad-all-3.0.5)

## v3.0.4

- [https://github.com/akshita-sahu/jad/releases/tag/jad-all-3.0.4](https://github.com/akshita-sahu/jad/releases/tag/jad-all-3.0.4)

## v2017-11-03

- [improvement] add [`getstatic`](getstatic.md)
- [bug] fix JAD class loader logs loading issues
...
- JAD 3.0 release :confetti_ball:

## v2016-12-09

- [feature] [`jad.sh`](https://github.com/akshita-sahu/jad/blob/master/bin/jad.sh) support `-h` to print help info
- [bug] [#121] fix leftover temp files causing JAD cannot start issue
- [bug] [#123] fix `attach/shutdown` repeatedly causing JAD classloader leakage issue
...
- [improvement] [#125] make the JAD log output more readable
- [improvement] [#96] [`sc`](sc.md) and more commands are supporting format as `com/akshita-sahu/xxx/TestClass`
...
- [bug] [#98] fix JAD starting issue: when updating/downloading failed, JAD will fail to start
- [bug] [#139] fix agent attaching fails under some scenarios issues
- [improvement] [#156] delay `jd-core-java` initialization to avoid JAD starting failure
...
- [bug] [#180] fix attach fails issues: attaching succeed at the first time, delete the JAD installer, re-compile and package => attaching fails
...
- [feature] interactive mode used in JAD
...
- [bug] fix JAD starting failure in OpenJdk issues (requiring to reinstall [jad.sh](https://github.com/akshita-sahu/jad/blob/master/bin/jad.sh))
