...
[`sysenv` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html?language=en&id=command-sysenv)
...
```
 ...
 WIKI:
   https://github.com/Akshita-Sahu/JAD/doc/sysenv
...
----------------------------------------------------------------------------------------------------------------------------
 ...
 LOGNAME                  admin
 XPC_SERVICE_NAME         0
 PWD                      /Users/admin/code/ali/jad/demo
