...
[`Log command outputs` online tutorial](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html?language=en&id=save-log)
...
- Log file path
  ...
  The command execution result will be save in `{user.home}/logs/jad-cache/result.log`. Pls. clean it up regularly to save disk space.
