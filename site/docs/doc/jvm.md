...
[`jvm`](https://github.com/Akshita-Sahu/JAD/doc/jad-tutorials.html?language=cn&id=command-jvm)
...
--------------------------------------------------------------------------------------------------------------
 ...
 INPUT-ARGUMENTS                []
 CLASS-PATH                     demo-jad-spring-boot.jar
...
- MAX-FILE-DESCRIPTOR-COUNT：JVM 
- OPEN-FILE-DESCRIPTOR-COUNT：JVM 
