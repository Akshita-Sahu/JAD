...
class HttpApiHandlerTest {
    ...
    void testExecRetransform_ReturnsIdsSuccess() throws Throwable {
        ...
        JADBootstrap instance = JADBootstrap.getInstance(instrumentation, "ip=127.0.0.1");
        ...
        String body = JSON.toJSONString(new Object() {
            ...
            public final String command = "retransform target/classes/com/akshita_sahu/jad/core/GlobalOptions.class";
