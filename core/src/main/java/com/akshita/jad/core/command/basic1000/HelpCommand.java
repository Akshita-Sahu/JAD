...
import com.akshita.jad.core.command.model.ArgumentVO;
import com.akshita.jad.core.command.model.CommandOptionVO;
...
public class HelpCommand extends AnnotatedCommand {
    ...
    private CommandVO createCommandVO(Command command, boolean withDetail) {
        ...
        if (cli!=null){
            ...
            if (withDetail){
                ...
                //arguments
                List<com.akshita_sahu.middleware.cli.Argument> arguments = cli.getArguments();
                for (int i = 0; i < arguments.size(); i++) {
                    com.akshita_sahu.middleware.cli.Argument argument = arguments.get(i);
    ...
    private ArgumentVO createArgumentVO(com.akshita_sahu.middleware.cli.Argument argument) {
