...
import com.akshita.jad.core.command.basic1000.*;
import com.akshita.jad.core.command.hidden.JulyCommand;
import com.akshita.jad.core.command.hidden.ThanksCommand;
import com.akshita.jad.core.command.klass100.ClassLoaderCommand;
import com.akshita.jad.core.command.klass100.DumpClassCommand;
import com.akshita.jad.core.command.klass100.GetStaticCommand;
import com.akshita.jad.core.command.klass100.JadCommand;
import com.akshita.jad.core.command.klass100.MemoryCompilerCommand;
import com.akshita.jad.core.command.klass100.OgnlCommand;
import com.akshita.jad.core.command.klass100.RedefineCommand;
import com.akshita.jad.core.command.klass100.RetransformCommand;
import com.akshita.jad.core.command.klass100.SearchClassCommand;
import com.akshita.jad.core.command.klass100.SearchMethodCommand;
import com.akshita.jad.core.command.logger.LoggerCommand;
import com.akshita.jad.core.command.monitor200.DashboardCommand;
import com.akshita.jad.core.command.monitor200.HeapDumpCommand;
import com.akshita.jad.core.command.monitor200.JvmCommand;
import com.akshita.jad.core.command.monitor200.MBeanCommand;
import com.akshita.jad.core.command.monitor200.MemoryCommand;
import com.akshita.jad.core.command.monitor200.MonitorCommand;
import com.akshita.jad.core.command.monitor200.PerfCounterCommand;
import com.akshita.jad.core.command.monitor200.ProfilerCommand;
import com.akshita.jad.core.command.monitor200.StackCommand;
import com.akshita.jad.core.command.monitor200.ThreadCommand;
import com.akshita.jad.core.command.monitor200.TimeTunnelCommand;
import com.akshita.jad.core.command.monitor200.TraceCommand;
import com.akshita.jad.core.command.monitor200.VmToolCommand;
import com.akshita.jad.core.command.monitor200.WatchCommand;
import com.akshita.jad.core.command.monitor200.ReportCommand;
import com.akshita.jad.core.command.monitor200.HealthCommand;
import com.akshita.jad.core.command.monitor200.CompareCommand;
import com.akshita.jad.core.command.monitor200.AlertCommand;
import com.akshita.jad.core.command.monitor200.ExportCommand;
...
public class BuiltinCommandPack implements CommandResolver {
    ...
    private void initCommands(List<String> disabledCommands) {
        ...
        commandClassList.add(ReportCommand.class);
        commandClassList.add(HealthCommand.class);
        commandClassList.add(CompareCommand.class);
        commandClassList.add(AlertCommand.class);
        commandClassList.add(ExportCommand.class);
        try {
