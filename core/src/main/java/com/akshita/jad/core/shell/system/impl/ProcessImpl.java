package com.akshita.jad.core.shell.system.impl;
...
import com.akshita.jad.core.command.basic1000.HelpCommand;
...
import com.akshita.jad.core.distribution.impl.TermResultDistributorImpl;
...
import com.akshita.jad.core.shell.command.internal.CloseFunction;
import com.akshita.jad.core.shell.command.internal.StatisticsFunction;
...
import com.akshita.jad.core.shell.term.Tty;
import com.akshita_sahu.middleware.cli.CLIException;
...
public class ProcessImpl implements Process {
    ...
    public synchronized void run(boolean fg) {
        ...
        if (resultDistributor == null) {
            resultDistributor = new TermResultDistributorImpl(process, JADBootstrap.getInstance().getResultViewResolver());
        }
        ...
        JADBootstrap.getInstance().execute(task);
    }
    ...
    private class CommandProcessImpl implements CommandProcess {
        ...
        public void unregister() {
            if (transformer != null) {
                JADBootstrap.getInstance().getTransformerManager().removeTransformer(transformer);
            }
