...
public class ShellServerOptions {
    ...
    public static final String DEFAULT_WELCOME_MESSAGE = JADBanner.welcome();

    public static final String DEFAULT_INPUTRC = "com/akshita_sahu/jad/core/shell/term/readline/inputrc";
