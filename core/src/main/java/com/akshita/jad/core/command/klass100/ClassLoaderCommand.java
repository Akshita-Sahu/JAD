package com.akshita.jad.core.command.klass100;
...
import com.akshita.jad.core.util.ResultUtils;
import com.akshita.jad.core.util.StringUtils;
import com.akshita.jad.core.util.affect.RowAffect;
...
public class ClassLoaderCommand extends AnnotatedCommand {
    ...
    //  ClassLoader URLClassLoaderurls
    ...
    /**
     * class, classloader，classloader，classloaderclass
     * <p>
     * hashCodenull，classloader
     *
     */
    ...
    static String guessJarName(String url) {
        if (url == null) {
            return com.akshita.jad.core.util.Constants.EMPTY_STRING;
        }
        String s = url;
    ...
    private static List<ClassLoaderInfo> getAllClassLoaderInfo(Instrumentation inst, Filter... filters) {
        // class.getClassLoader()nullBootstrapClassLoader，
