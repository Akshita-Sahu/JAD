...
/**
 *  async-profiler  collapsed stacktraces ， LLM  Markdown 。
 * <p>
 * ：
 * 1) ， LLM
 * 2) Token ：、、 grep
...
final class ProfilerMarkdown {
    ...
    static String toMarkdown(Options options) {
        ...
        sb.append("# JAD profiler report (Markdown)\n\n");
        ...
        sb.append("## Notes\n\n");
        sb.append("-  JAD  async-profiler  `collapsed` ， LLM 。\n");
        sb.append("- `hotspots (self)` （ self time），。\n");
        sb.append("- `stacks` ； `--format flamegraph`.\n");
    ...
    private static CollapsedProfile parseCollapsed(String collapsed, boolean threadsEnabled) {
        ...
        for (String line : lines) {
            ...
            // collapsed ：frame1;frame2;frame3 <samples>
    ...
    private static String topFrame(String stack, boolean threadsEnabled) {
        ...
        // threads ，async-profiler “”；，：
        // ： top  [thread]  "(thread)" ，， frame。
    ...
    private static String stripThreadFrame(String stack, boolean threadsEnabled) {
        ...
        // async-profiler threads ：[tid=1234] "thread-name"
    ...
    private static boolean looksLikeThreadFrame(String frame) {
        ...
        // async-profiler ：[tid=1234] "thread-name"
