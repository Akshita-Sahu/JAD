...
import com.akshita_sahu.bytekit.asm.binding.Binding;
import com.akshita_sahu.bytekit.asm.interceptor.annotation.AtEnter;
import com.akshita_sahu.bytekit.asm.interceptor.annotation.AtExceptionExit;
import com.akshita_sahu.bytekit.asm.interceptor.annotation.AtExit;
import com.akshita_sahu.bytekit.asm.interceptor.annotation.AtInvoke;
import com.akshita_sahu.bytekit.asm.interceptor.annotation.AtInvokeException;
...
public class SpyInterceptors {
    ...
    public static class SpyTraceInterceptor1 {
        @AtInvoke(name = "", inline = true, whenComplete = false, excludes = {"java.jad.SpyAPI", "java.lang.Byte"
                , "java.lang.Boolean"
                , "java.lang.Short"
                , "java.lang.Character"
                , "java.lang.Integer"
    ...
    public static class SpyTraceInterceptor2 {
        @AtInvoke(name = "", inline = true, whenComplete = true, excludes = {"java.jad.SpyAPI", "java.lang.Byte"
                , "java.lang.Boolean"
                , "java.lang.Short"
                , "java.lang.Character"
                , "java.lang.Integer"
    ...
    public static class SpyTraceInterceptor3 {
        @AtInvokeException(name = "", inline = true, excludes = {"java.jad.SpyAPI", "java.lang.Byte"
                , "java.lang.Boolean"
                , "java.lang.Short"
                , "java.lang.Character"
                , "java.lang.Integer"
