...
import com.akshita.jad.core.command.model.BlockingLockInfo;
import com.akshita.jad.core.command.model.BusyThreadInfo;
import com.akshita.jad.core.command.model.StackModel;
import com.akshita.jad.core.command.model.ThreadNode;
...
/**
 * 
 * @author hengyunabc 2015127 2:29:28
 *
 */
abstract public class ThreadUtil {
     ...
     * @param lockIdentityHashCode identityHashCode
     * @param blockingThreadCount 
     ...
     * com.akshita.jad.core.util.ThreadUtil.getThreadStack(ThreadUtil.java:349),
     * com.akshita.jad.core.command.monitor200.StackAdviceListener.before(StackAdviceListener.java:33),
     * com.akshita.jad.core.advisor.AdviceListenerAdapter.before(AdviceListenerAdapter.java:49),
     * com.akshita.jad.core.advisor.SpyImpl.atEnter(SpyImpl.java:42),
     * java.jad.SpyAPI.atEnter(SpyAPI.java:40),
    ...
    private static void getEagleeyeTraceInfo(ClassLoader loader, Thread currentThread, StackModel stackModel) {
        ...
        if (!detectedEagleEye) {
            try {
                eagleEyeClass = loader.loadClass("com.akshita_sahu.eagleeye.EagleEye");
                foundEagleEye = true;
            } catch (Throwable e) {
                // ignore
            }
