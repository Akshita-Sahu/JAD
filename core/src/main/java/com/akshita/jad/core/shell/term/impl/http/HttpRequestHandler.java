...
import static com.akshita.jad.core.util.HttpUtils.createRedirectResponse;
import static com.akshita.jad.core.util.HttpUtils.createResponse;
...
public class HttpRequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    public HttpRequestHandler(String wsUri) {
        this(wsUri, JADBootstrap.getInstance().getOutputPath());
    }
    ...
    public HttpRequestHandler(String wsUri, File dir) {
        ...
        this.dir = dir;
        dir.mkdirs();
        this.httpApiHandler = JADBootstrap.getInstance().getHttpApiHandler();
        this.mcpRequestHandler = JADBootstrap.getInstance().getMcpRequestHandler();
    }
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        ...
        if (wsUri.equalsIgnoreCase(path)) {
            ...
            try {
                ...
                logger.error("jad process http request error: " + request.uri(), e);
            } finally {
    ...
    private HttpResponse readFileFromResource(FullHttpRequest request, String path) throws IOException {
        ...
        InputStream in = null;
        try {
            URL res = HttpTtyConnection.class.getResource("/com/akshita_sahu/jad/core/http" + path);
            if (res != null) {
