...
public class FileUtils {
    ...
    private static boolean isAuthCommand(String command) {
        //  auth command, TODO mask
        return command != null && command.trim().startsWith(JADConstants.AUTH);
    }

    private static final int[] AUTH_CODEPOINTS = Helper.toCodePoints(JADConstants.AUTH);
    /**
    ...
    public static Properties readProperties(String file) throws IOException {
        ...
        try {
            ...
            com.akshita.jad.common.IOUtils.close(in);
        }
