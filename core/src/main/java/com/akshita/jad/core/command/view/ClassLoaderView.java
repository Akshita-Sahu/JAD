...
import com.akshita.jad.core.command.klass100.ClassLoaderCommand.ClassLoaderStat;
import com.akshita.jad.core.command.klass100.ClassLoaderCommand.ClassLoaderUrlStat;
import com.akshita.jad.core.command.klass100.ClassLoaderCommand.UrlClassStat;
import com.akshita.jad.core.command.model.ClassDetailVO;
import com.akshita.jad.core.command.model.ClassLoaderModel;
import com.akshita.jad.core.command.model.ClassLoaderVO;
import com.akshita.jad.core.command.model.ClassSetVO;
...
import com.akshita_sahu.text.ui.*;
...
public class ClassLoaderView extends ResultView<ClassLoaderModel> {
    ...
    private void drawUrlStats(CommandProcess process, Map<ClassLoaderVO, ClassLoaderUrlStat> urlStats) {
        for (Entry<ClassLoaderVO, ClassLoaderUrlStat> entry : urlStats.entrySet()) {
            ...
            //  sun.reflect.DelegatingClassLoader ClassLoader
    ...
    private void drawClassLoaderUrls(CommandProcess process, List<String> urls) {
        ...
        process.write(com.akshita.jad.core.util.Constants.EMPTY_STRING);
    }
