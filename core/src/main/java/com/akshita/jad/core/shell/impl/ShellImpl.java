...
import com.akshita.jad.core.shell.handlers.shell.*;
import com.akshita.jad.core.shell.session.Session;
import com.akshita.jad.core.shell.session.impl.SessionImpl;
...
import com.akshita.jad.core.shell.term.impl.http.ExtHttpTtyConnection;
    ...
    public void close(String reason) {
        if (term != null) {
            try {
                ...
                // https://github.com/akshita_sahu/jad/issues/320
