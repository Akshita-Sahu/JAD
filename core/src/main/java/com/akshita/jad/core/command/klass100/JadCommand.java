...
import com.akshita.jad.core.command.model.ClassVO;
import com.akshita.jad.core.command.model.ClassLoaderVO;
import com.akshita.jad.core.command.model.JadModel;
...
import com.akshita.jad.core.util.*;
...
public class JadCommand extends AnnotatedCommand {
    ...
    private ExitStatus processExactMatch(CommandProcess process, RowAffect affect, Instrumentation inst, Set<Class<?>> matchedClasses, Set<Class<?>> withInnerClasses) {
        ...
        try {
            ...
            return ExitStatus.failure(-1, "jad: fail to decompile class: " + c.getName() + ", please check $HOME/logs/jad/jad.log for more details.");
        }
    }
