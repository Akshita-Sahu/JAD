package com.akshita.jad.core.shell.term.impl.httptelnet;

import java.util.concurrent.TimeUnit;

import com.akshita.jad.common.JADConstants;
import com.akshita.jad.core.shell.term.impl.http.BasicHttpAuthenticatorHandler;
import com.akshita.jad.core.shell.term.impl.http.HttpRequestHandler;

import com.akshita.jad.core.shell.term.impl.http.TtyWebSocketFrameHandler;
...
public class ProtocolDetectHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (!"GET".equalsIgnoreCase(httpHeader)) { // telnet
            ...
            pipeline.addLast(workerGroup, "HttpRequestHandler", new HttpRequestHandler(JADConstants.DEFAULT_WEBSOCKET_PATH));
            pipeline.addLast(new WebSocketServerProtocolHandler(JADConstants.DEFAULT_WEBSOCKET_PATH, null, false, JADConstants.MAX_HTTP_CONTENT_LENGTH, false, true));
