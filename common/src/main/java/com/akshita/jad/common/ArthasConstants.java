...
public class JADConstants {
     ...
     */
    public static final String NETTY_LOCAL_ADDRESS = "jad-netty-LocalAddress";

    public static final int MAX_HTTP_CONTENT_LENGTH = 1024 * 1024 * 10;

    public static final String JAD_OUTPUT = "jad-output";
    ...
    public static final String DEFAULT_USERNAME = "jad";
