...
import com.akshita.jad.grpc.server.utils.ReflectUtil;
...
public class GrpcDispatcher {
    ...
    public static final String DEFAULT_GRPC_SERVICE_PACKAGE_NAME = "com.akshita.jad.grpc.server.service.impl";
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (actualTypeArguments.length > 0) {
                ...
                if (innerType instanceof ParameterizedType) {
                    return getInnerGenericClass(innerType); // 
                } else if (innerType instanceof Class) {
                    return (Class<?>) innerType; //  Class 
                }
            }
        }
        return null; // 
