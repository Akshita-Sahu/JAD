package com.akshita.jad.nat.agent.proxy.factory;
...
public class NativeAgentProxyRegistryFactory {
    ...
    private static final String FILE_PATH = "META-INF/jad/com.akshita.jad.native.agent.proxy.NativeAgentProxyRegistryFactory";
