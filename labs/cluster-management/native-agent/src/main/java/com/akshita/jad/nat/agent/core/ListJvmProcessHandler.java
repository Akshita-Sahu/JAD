...
/**
 * @description: list java process via invoke com.akshita.jad.boot.ProcessUtils#listProcessByJps
 * @author：flzjkl
...
public class ListJvmProcessHandler {
    ...
    private static final String PROCESS_UTILS_PATH = "com.akshita.jad.boot.ProcessUtils";
    ...
    public static Map<Long, String> listJvmProcessByInvoke()  {
        ...
        String jadBootPath = JAD_HOME_DIR + File.separator + "jad-boot.jar";
        Method method = null;
        Object instance = null;
        Map<Long, String> result = null;

        try {
            URLClassLoader classLoader = new URLClassLoader(new URL[]{new File(jadBootPath).toURI().toURL()});
