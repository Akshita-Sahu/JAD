...
public class MonitorTargetPidHandler {
    ...
    public static boolean monitorTargetPid (Integer pid)  {
        long tcpListenProcess = SocketUtils.findTcpListenProcess(NativeAgentConstants.JAD_SERVER_HTTP_PORT);
        ...
        if (tcpListenProcess != pid) {
            String errorMsg = "Target port: " + NativeAgentConstants.JAD_SERVER_HTTP_PORT
