package com.akshita.jad.nat.agent.server.forward;
...
/**
 * @description: Forward the ws request to jad server
 * @author：flzjkl
...
public class ForwardClientSocketClientHandler extends SimpleChannelInboundHandler<WebSocketFrame> {
    ...
    private void connectLocalServer(final ChannelHandlerContext ctx) throws InterruptedException, URISyntaxException {
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pipeline.addLast(new WebSocketClientProtocolHandler(
                                WebSocketClientHandshakerFactory.newHandshaker(
                                        new URI("ws://127.0.0.1:" + NativeAgentConstants.JAD_SERVER_HTTP_PORT + "/ws"),
        ...
        // Connect to jad server
        Channel jadChannel = bootstrap.connect("127.0.0.1", NativeAgentConstants.JAD_SERVER_HTTP_PORT).sync().channel();
        ...
        ctx.pipeline().addLast(new RelayHandler(jadChannel));
