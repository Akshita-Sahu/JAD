package com.akshita.jad.nat.agent.management.web.factory;
...
public class NativeAgentProxyDiscoveryFactory {
    ...
    private static final String FILE_PATH = "META-INF/jad/com.akshita.jad.native.agent.management.web.NativeAgentProxyDiscoveryFactory";
