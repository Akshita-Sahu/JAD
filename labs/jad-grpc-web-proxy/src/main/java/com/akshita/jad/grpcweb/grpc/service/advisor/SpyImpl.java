...
import java.jad.SpyAPI.AbstractSpy;
import java.util.List;

/**
 * <pre>
 *  className|methodDesc  id ？？
 * id，id？
 * 
 *  className|methodDesc  key ，
 * </pre>
 * 
...
public class SpyImpl extends AbstractSpy {
    ...
    public void atEnter(Class<?> clazz, String methodInfo, Object target, Object[] args) {
        ...
        // TODO listener ， thread local！
        List<AdviceListener> listeners = com.akshita.jad.grpcweb.grpc.service.advisor.AdviceListenerManager.queryAdviceListeners(classLoader, clazz.getName(),
    ...
    public void atBeforeInvoke(Class<?> clazz, String invokeInfo, Object target) {
        ...
        List<AdviceListener> listeners = com.akshita.jad.grpcweb.grpc.service.advisor.AdviceListenerManager.queryTraceAdviceListeners(classLoader, clazz.getName(),
