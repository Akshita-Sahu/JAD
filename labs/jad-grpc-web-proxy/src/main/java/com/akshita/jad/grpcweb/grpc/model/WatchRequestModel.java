...
public class WatchRequestModel extends EnhancerRequestModel {
    ...
    @Override
    protected AdviceListener getAdviceListener(JADStreamObserver jadStreamObserver) {
        WatchRequestModel watchRequestModel = (WatchRequestModel) jadStreamObserver.getRequestModel();
        ...
        return new WatchRpcAdviceListener(jadStreamObserver, GlobalOptions.verbose || watchRequestModel.isVerbose());
    }
