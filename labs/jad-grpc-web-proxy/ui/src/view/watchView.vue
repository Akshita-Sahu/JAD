...
import {
  WatchClient,
  ObjectServiceClient
} from '@/assets/proto/JADServices_grpc_web_pb';

import { WatchRequest, ObjectQuery } from '@/assets/proto/JADServices_grpc_web_pb';
...
export default {
  ...
  methods:{
    ...
    handleClick(item) {
      ...
      this.objectQueryModel.className = "com.akshita.jad.grpcweb.grpc.service.GrpcJobController"
