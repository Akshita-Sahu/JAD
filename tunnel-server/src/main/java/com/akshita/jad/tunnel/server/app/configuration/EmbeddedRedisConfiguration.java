...
import com.akshita.jad.tunnel.server.app.configuration.JADProperties.EmbeddedRedis;
...
public class EmbeddedRedisConfiguration {
    ...
    @ConditionalOnProperty(prefix = "jad", name = { "embedded-redis.enabled" })
    public RedisServer embeddedRedisServer(JADProperties jadProperties) {
        EmbeddedRedis embeddedRedis = jadProperties.getEmbeddedRedis();
