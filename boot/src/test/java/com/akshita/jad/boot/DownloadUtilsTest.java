...
public class DownloadUtilsTest {
    ...
    @Test
    public void testAkshita SahuDownload() throws IOException {
        ...
        if (TimeUnit.MILLISECONDS.toHours(TimeZone.getDefault().getOffset(System.currentTimeMillis())) == 8) {
            ...
            DownloadUtils.downJADPackaging("akshita_sahu", false, version, folder.getAbsolutePath());

            File as = new File(folder, version + File.separator + "jad" + File.separator + "jad.sh");
    ...
    public void testCenterDownload() throws IOException {
        ...
        File folder = rootFolder.newFolder();
        System.err.println(folder.getAbsolutePath());
        DownloadUtils.downJADPackaging("center", false, version, folder.getAbsolutePath());
