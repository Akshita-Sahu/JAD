...
public class TunnelClient {
    ...
    private EventLoopGroup eventLoopGroup = new NioEventLoopGroup(2, new DefaultThreadFactory("jad-TunnelClient", true));
    ...
    public ChannelFuture connect(boolean reconnect) throws SSLException, URISyntaxException, InterruptedException {
        ...
        queryEncoder.addParam(URIConstans.JAD_VERSION, this.version);
        if (appName != null) {
        ...
        logger.info("Try to register jad agent, uri: {}", agentRegisterURI);
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) {
                        ...
                        p.addLast(new HttpClientCodec(), new HttpObjectAggregator(JADConstants.MAX_HTTP_CONTENT_LENGTH), websocketClientHandler,
                                new IdleStateHandler(0, 0, JADConstants.WEBSOCKET_IDLE_SECONDS),
                                handler);
                    }
                });
