...
package com.akshita.jad.mcp.server.protocol.spec;
...
import com.akshita.jad.mcp.server.protocol.server.McpNotificationHandler;
import com.akshita.jad.mcp.server.protocol.server.McpRequestHandler;
...
import com.akshita.jad.mcp.server.util.Assert;
...
import static com.akshita.jad.mcp.server.util.McpAuthExtractor.MCP_AUTH_SUBJECT_KEY;
...
public class McpStreamableServerSession implements McpSession {
    ...
    public CompletableFuture<Void> responseStream(McpSchema.JSONRPCRequest jsonrpcRequest, 
        ...
        JADCommandContext commandContext = createCommandContext(transportContext.get(MCP_AUTH_SUBJECT_KEY));
     ...
     * @return 
     */
    private JADCommandContext createCommandContext(Object authSubject) {
        JADCommandSessionManager.CommandSessionBinding binding = commandSessionManager.getCommandSession(this.id, authSubject);
        return new JADCommandContext(commandExecutor, binding);
    }
}
