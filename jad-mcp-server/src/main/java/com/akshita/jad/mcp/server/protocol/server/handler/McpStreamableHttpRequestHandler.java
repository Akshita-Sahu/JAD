...
package com.akshita.jad.mcp.server.protocol.server.handler;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.akshita.jad.mcp.server.util.McpAuthExtractor;
import com.akshita.jad.mcp.server.protocol.server.DefaultMcpTransportContext;
import com.akshita.jad.mcp.server.protocol.server.McpTransportContext;
import com.akshita.jad.mcp.server.protocol.server.McpTransportContextExtractor;
import com.akshita.jad.mcp.server.protocol.spec.HttpHeaders;
import com.akshita.jad.mcp.server.protocol.spec.*;
import com.akshita.jad.mcp.server.util.Assert;
import com.akshita.jad.mcp.server.util.KeepAliveScheduler;
...
public class McpStreamableHttpRequestHandler {
    ...
    private void handleGetRequest(ChannelHandlerContext ctx, FullHttpRequest request) {
        ...
        // MCP  SSE ， last-event-id 。
        // JAD MCP Server  last-event-id ： 404，
        //  Initialize 。
